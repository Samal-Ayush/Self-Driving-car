class Trainer:
    def _init_(self, model, log_dir, logger, l2_norm_const=0.001, learning_rate=1e-4):
    ...
    def _train_one_epoch(self, epoch, batch_size):
        for i in range(int(driving_data.num_images / batch_size)):
            ...
            self.train_step.run(feed_dict={model.x: xs, model.y_: ys, model.keep_prob: 1.0})
    ...
    def _log_progress(self, epoch, step, batch_size):
        ...
        summary = self.merged_summary_op.eval(feed_dict={model.x: xs, model.y_: ys})
        self.logger.log_summary(summary, epoch * driving_data.num_images / batch_size)
...
if __name__ == "__main__":
    ...
    LOGS_PATH = 'model_training/train_steering_angle/logs2'
    EPOCHS = 30
    BATCH_SIZE = 100
    ...
    print("Run the command line:\n"
          "--> tensorboard --logdir=model_training/train_steering_angle/logs2 "
